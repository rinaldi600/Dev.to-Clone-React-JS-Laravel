                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={'max-w-[544px] min-h-[38.6px] rounded-lg mt-2'}>
                        ...
                        <p id="filled_success_help" className="mt-2 text-xs text-green-600 dark:text-green-400"><span
                            className="font-medium">{ data.name !== '' && !('name' in errors) ? 'Well done!' : ''}</span></p>
                    </div>
                    ...
                    <div className={'max-w-[544px] min-h-[38.6px] rounded-lg mt-2'}>
                        ...
                        <p id="filled_success_help" className="mt-2 text-xs text-green-600 dark:text-green-400"><span
                            className="font-medium">{ data.email !== '' && !('email' in errors) ? 'Well done!' : ''}</span></p>
                    </div>
                    ...
                    <div className={'max-w-[544px] min-h-[38.6px] rounded-lg mt-2'}>
                        ...
                        <p id="filled_success_help" className="mt-2 text-xs text-green-600 dark:text-green-400"><span
                            className="font-medium">{ data.password !== '' && !('password' in errors) ? 'Well done!' : ''}</span></p>
                    </div>
