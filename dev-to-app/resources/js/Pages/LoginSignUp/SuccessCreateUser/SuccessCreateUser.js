...
function SuccessCreateUser() {
    return (
        <div className={'absolute flex items-center justify-center h-full bg-[#888888]/50 inset-0 bg-black'}>
            <div className={'w-[500px]'}>
                <div className="flex p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800"
                    ...
                    <div>
                        <span className="font-medium">Success!</span> Please <Link className={'font-medium'} href={'/enter'}>Log in</Link>.
                    </div>
                </div>
            </div>
        </div>
