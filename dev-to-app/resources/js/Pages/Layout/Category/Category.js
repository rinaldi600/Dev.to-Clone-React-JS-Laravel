...
import SubCategory from "@/Pages/Layout/Category/SubCategory/SubCategory";
import SocialMedia from "@/Pages/Layout/SocialMedia/SocialMedia";

function Category() {
    return (
        <div className={'p-2'}>
            <div className={'h-full'}>
                <SubCategory text={'Home'} href={'/'} svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                ...
                <SubCategory svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                    <g className="nc-icon-wrapper">
                        <path fill="#67757F"
                ...
                </svg>} href={'/'} text={'Reading List'}/>
                <SubCategory svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                    <g className="nc-icon-wrapper">
                        <path fill="#FFD983"
                              d="M36 4H14a4 4 0 00-4 4v24H8a4 4 0 000 8h24a4 4 0 004-4V12a4 4 0 000-8z"></path>
                        <path fill="#E39F3D" d="M12 14h24v-2H14l-2-1z"></path>
                        <path fill="#FFE8B6"
                              d="M14 4a4 4 0 00-4 4v24.555A3.955 3.955 0 008 32a4 4 0 104 4V11.445c.59.344 1.268.555 2 .555a4 4 0 000-8z"></path>
                        <path fill="#C1694F"
                              d="M16 8a2 2 0 11-4.001-.001A2 2 0 0116 8m-6 28a2 2 0 11-4.001-.001A2 2 0 0110 36m24-17a1 1 0 01-1 1H15a1 1 0 010-2h18a1 1 0 011 1m0 4a1 1 0 01-1 1H15a1 1 0 110-2h18a1 1 0 011 1m0 4a1 1 0 01-1 1H15a1 1 0 110-2h18a1 1 0 011 1m0 4a1 1 0 01-1 1H15a1 1 0 110-2h18a1 1 0 011 1"></path>
                    </g>
                </svg>} text={'Listings'} href={'/'}/>
                <SubCategory svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                    <g className="nc-icon-wrapper">
                        <path fill="#292F33"
                ...
                </svg>} text={'Sponsors'} href={'/'}/>
                <SubCategory svg={<svg viewBox="0 0 235 234" xmlns="http://www.w3.org/2000/svg" className="rainbow-logo w-[24px] h-[24px]"
                                       preserveAspectRatio="xMinYMin meet">
                    <g fill="none" fill-rule="evenodd">
                        <path fill="#88AEDC" d="M234.04 175.67l-75.69 58.28h47.18L234.04 212z"></path>
                        <path
                            d="M234.04 140.06l-121.93 93.89h.02l121.91-93.87zM133.25.95L.04 103.51v.02L133.27.95z"></path>
                ...
                <SubCategory svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                    <g className="nc-icon-wrapper">
                        ...
                        <path fill="#BE1931"
                              d="M17.091 33.166a9.487 9.487 0 01-4.045-8.72l-3.977-.461c-.046.452-.069.911-.069 1.376 0 4.573 2.28 8.608 5.76 11.051l2.331-3.246z"></path>
                        <path fill="#BE1931"
                              d="M10 29.924s-5.188-.812-5 1 5-1 5-1zm0 .312s-4.125 2.688-2.938 3.75S10 30.236 10 30.236z"></path>
                    </g>
                </svg>} text={'Contact'} href={'/'}/>
            </div>
            <div>
                <p className={'font-bold text-base p-2'}>Other</p>
                <div className={'h-full'}>
                    <SubCategory text={'Code of product'} href={'/'} svg={<svg xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 44 44" width="24" height="24">
                        <g className="nc-icon-wrapper">
                            <path fill="#FFDB5E"
                    ...
                    <SubCategory text={'Privacy Policy'} href={'/'} svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                        <g transform="translate(4 4)">
                    ...
                    <SubCategory text={'Terms of use'} href={'/'} svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                        <g transform="translate(4 4)">
            ...
            <div className={'flex mt-3'}>
                <SocialMedia svg={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img"
                                       className="crayons-icon c-link__icon"><title id="ath8iikx308w0moloqmbhy5z2zzlhl4s">Twitter</title>
                    <path
                ...
                <SocialMedia svg={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                       role="img" aria-labelledby="a3ljayzi0k26tiloalyrufna3hncsivg"
                                       className="crayons-icon c-link__icon"><title
                    id="a3ljayzi0k26tiloalyrufna3hncsivg">Facebook</title>
                    <path
                        d="M15.402 21v-6.966h2.333l.349-2.708h-2.682V9.598c0-.784.218-1.319 1.342-1.319h1.434V5.857a19.188 19.188 0 00-2.09-.107c-2.067 0-3.482 1.262-3.482 3.58v1.996h-2.338v2.708h2.338V21H4a1 1 0 01-1-1V4a1 1 0 011-1h16a1 1 0 011 1v16a1 1 0 01-1 1h-4.598z"></path>
                </svg>}/>
                <SocialMedia svg={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                       role="img" aria-labelledby="ae91hsx9h60b4fqvxzifhkfpqa556zk9"
                                       className="crayons-icon c-link__icon"><title
                    id="ae91hsx9h60b4fqvxzifhkfpqa556zk9">Github</title>
                    <path
                ...
                <SocialMedia svg={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                       role="img" aria-labelledby="adr3t0higgjzw05f9n97hx3peykksbkm"
                                       className="crayons-icon c-link__icon"><title
                    id="adr3t0higgjzw05f9n97hx3peykksbkm">Instagram</title>
                    <path
                ...
                <SocialMedia svg={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                       role="img" aria-labelledby="aae3z5ge376k4tp2nt5yiwhvx4u051lz"
                                       className="crayons-icon c-link__icon"><title
                    id="aae3z5ge376k4tp2nt5yiwhvx4u051lz">Twitch</title>
                    <path
                        d="M4.3 3H21v11.7l-4.7 4.7h-3.9l-2.5 2.4H7v-2.4H3V6.2L4.3 3zM5 17.4h4v2.4h.095l2.5-2.4h3.877L19 13.872V5H5v12.4zM15 8h2v4.7h-2V8zm0 0h2v4.7h-2V8zm-5 0h2v4.7h-2V8z"></path>
                </svg>}/>
            </div>
        </div>
    )
