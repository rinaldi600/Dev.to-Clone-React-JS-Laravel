    ...
    return (
        <div key={key} className="w-full p-4 hover:bg-[#F9F9F9] flex justify-between items-center min-h-[64px] border-b-2 border-[#EFEFEF] bg-white">
            <div className="w-[50%]">
                ...
                <p className="text-sm break-words text-[#717171]"><span className="font-medium">Published:</span> {moment(detail?.created_at).format('MMMM Do YYYY, h:mm:ss a')}</p>
            </div>
            <div className="flex items-center justify-center gap-2 w-[25%] flex-wrap">
            ...
            <div className="flex items-center justify-end w-[25%] flex-wrap">
