        ...
        <div className="mt-3 flex justify-end w-full min-h-[88.5px]">
            <div className="w-[92%] sm:w-full pl-2 pr-2 border border-[#EFEFEF] overflow-hidden rounded-lg min-h-fit">
                ...
                <div className="flex items-center gap-3 min-h-[36.8px] p-1 justify-start">
                    <button onClick={() => showComment(true)} type="button" className="flex text-[#090909] text-sm hover:bg-[#F6F6F6] rounded-lg p-1.5 items-center justify-center gap-1">
                    ...
                    <Link href={detailComment} className="flex text-[#090909] text-sm hover:bg-[#F6F6F6] rounded-lg p-1.5 items-center justify-center gap-1">
