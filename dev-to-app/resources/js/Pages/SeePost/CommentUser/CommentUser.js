                ...
                <div className="w-[90%]">
                    <div class="w-full mb-4 rounded-lg">
                        ...
                        <div class="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
                            <button onClick={showComment} type="button" class="flex items-center justify-center text-sm font-normal text-[#090909] gap-2 hover:bg-[#F6F6F6] rounded-lg w-[81.6875px] h-[32px]">
                                <div>
