...
const SuccessUpload = React.lazy(() => import('../NewPost/successUpload/SuccessUpload'));
const DeleteUpload = React.lazy(() => import('../NewPost/deleteUpload/DeleteUpload'));
const TagPost = React.lazy(() => import('../NewPost/tagPost/TagPost'));
                            ...
                            <div className="pt-8 pl-16 w-full">
                                <div>
                                    <div className="mb-3 w-[70%]">
                                        ...
                                        src={ previewImage.length > 0 ? previewImage : data.cover } alt="Cover Image" />
                                    </div>
                                ...
                                <div className="mb-6">
                                    <textarea defaultValue={detailPost.title} autoFocus={true} onKeyUp={(e) => setData('title', e.target.value)} style={{height : `${heightTextArea > 0 ? `${heightTextArea}px` : '64px'}`}} onKeyDown={(e) => autoSize(e)} class={`block w-[90%] min-h-fit text-5xl font-extrabold text-[#171717] mt-3 border-transparent focus:border-transparent focus:ring-0 resize-none overflow-hidden`} placeholder="New post title here..."></textarea>
                                    {
                                        errors?.title &&
